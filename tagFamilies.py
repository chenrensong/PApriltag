...
class Tag36h11class(Tagclass):
    def __init__(self,hammingdis = 3,debug = False):
        super(Tag36h11class,self).__init__(GLOBAL_TAG36H11,6,debug,hammingdis)
class Tag16h5class(Tagclass):
    def __init__(self,hammingdis = 2,debug = False):
        super(Tag16h5class,self).__init__(GLOBAL_TAG25H9, 4, debug, hammingdis)
class Tag25h9class(Tagclass):
    def __init__(self,hammingdis = 2,debug = False):
        super(Tag25h9class,self).__init__(GLOBAL_TAG25H9, 5, debug, hammingdis)
